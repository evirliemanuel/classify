...
import com.lieverandiver.thesisproject.adapter.ExamGradeAdapter;
...
public class ActivityGradeExam extends AppCompatActivity {
    ...
    private ExamGradeAdapter gradeAdapter;
    ...
    protected void onResume() {
        ...
        gradeAdapter = new ExamGradeAdapter(getApplicationContext(), gradeList, 1);
