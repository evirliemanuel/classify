...
public class AssignmentResultAdapter extends RecyclerView
        .Adapter<AssignmentResultAdapter.SimpleAssignmentViewHolder> {
    ...
    public AssignmentResultAdapter(Context context, List<AssignmentResult> resultList, int totalItem) {
