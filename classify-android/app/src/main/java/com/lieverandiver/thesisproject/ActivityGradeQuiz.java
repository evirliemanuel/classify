...
import com.lieverandiver.thesisproject.adapter.QuizGradeAdapter;
...
public class ActivityGradeQuiz extends AppCompatActivity {
    ...
    private QuizGradeAdapter gradeAdapter;
    ...
    protected void onResume() {
        ...
        gradeAdapter = new QuizGradeAdapter(getApplicationContext(), gradeList, 1);
