...
public class AssignmentResultAdapterF extends RecyclerView
        .Adapter<AssignmentResultAdapterF.SimpleAssignmentViewHolder> {
    ...
    public AssignmentResultAdapterF(Context context, List<AssignmentResult> resultList, int totalItem) {
    ...
    @Override
    public SimpleAssignmentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.activity_all_result_cardview, parent,false);
        return new SimpleAssignmentViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SimpleAssignmentViewHolder holder, int position) {
    ...
    class SimpleAssignmentViewHolder extends RecyclerView.ViewHolder {
        ...
        SimpleAssignmentViewHolder(View itemView) {
            super(itemView);
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try{
                            ...
                            assignmentService.updateAssignmentResultByAssignmentAndStudentId(
                                    Integer.parseInt(txScore.getText().toString()),
                                    result.getAssignment().getId(), result.getStudent().getId());
            ...
            AlertDialog dialog = new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            try{
                                AssignmentService assignmentService = new AssignmentServiceImpl();
                                assignmentService.deleteAssignmentResultByAssignmentAndStudentId(
                                        result.getAssignment().getId(), result.getStudent().getId());
                                List<AssignmentResult> cResultList = new ArrayList<>();
