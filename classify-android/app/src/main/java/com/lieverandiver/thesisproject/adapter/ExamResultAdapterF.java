...
public class ExamResultAdapterF extends RecyclerView
        .Adapter<ExamResultAdapterF.SimpleExamViewHolder> {

    private LayoutInflater layoutInflater;
    private List<ExamResult> resultList;
    private Context context;
    private ExamAdapterF.OnClickListener onClickListener;
    private int totalItem;

    public ExamResultAdapterF(Context context, List<ExamResult> resultList, int totalItem) {
